...
export function Lista() {
  const data = [
    { key: 1, name: 'Davy Woolley', funcao: '+55 (081) 99999-9999', imagem: 'https://benettoncomunicacao.com.br/imagens/posts/zoom/benetton-comunicacao-kobe-bryant-quando-uma-pessoa-se-torna-mais-que-uma-pessoa.png' },
